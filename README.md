...
[![Release](https://img.shields.io/badge/Release-v0.3.0-green?style=flat)](https://github.com/littleseven2003/astrbot_plugin_onepercent_generator/releases/latest)
...
| 生成后发送搜索信息摘要 | 布尔 | 开启后每次生成后额外发送搜索信息汇总（搜索源、摘要片段等） | `true` |
